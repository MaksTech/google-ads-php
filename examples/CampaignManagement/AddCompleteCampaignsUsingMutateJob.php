...
class AddCompleteCampaignsUsingMutateJob
{
    ...
    public static function main()
    {
        ...
        $googleAdsClient = (new GoogleAdsClientBuilder())
            ...
            ->build();
        // We need to instantiate GoogleAdsFailure to make the library aware of
        // possible failures during executing mutate jobs.
        // This is specific to only this PHP client library.
    ...
    private static function buildAllOperations(int $customerId)
    {
        ...
        // Creates new campaign operations and add them to the array of mutate operations.
        ...
        // Creates new campaign criterion operations and add them to the array of mutate operations.
        $mutateOperations = array_merge($mutateOperations, array_map(
        ...
        // Creates new campaign ad group operations and add them to the array of mutate operations.
        ...
        $mutateOperations = array_merge($mutateOperations, array_map(
            ...
            self::buildAdGroupOperations($customerId, $campaignOperations)
        ));

        // Creates new ad group criterion operations and add them to the array of mutate operations.
        $mutateOperations = array_merge($mutateOperations, array_map(
        ...
        // Creates new ad group ad operations and add them to the array of mutate operations.
        $mutateOperations = array_merge($mutateOperations, array_map(
